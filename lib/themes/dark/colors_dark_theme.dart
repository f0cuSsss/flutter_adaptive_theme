...
class _lightColors extends IThemeColors {
  ...
  @override
  Color appBackground = const Color(0xFF15131C);

  @override
  Color btnBackground = const Color(0xFF6EFFF0);

  @override
  Color cardBackground = const Color(0xFF09041E);
  ...
  @override
  Color onBtnBackground = const Color(0xFF03002D);

  @override
  Color onCardBackground = Colors.black.withOpacity(0.5);

  @override
  Color primary = const Color(0xFFEFF3F8);
...
class ColorsDarkTheme implements IColors {
  @override
